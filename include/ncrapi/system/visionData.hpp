...
const size_t COLOR_DATASUM = 4; //总颜色数量 -1 数据1根据红蓝方赋值
class VisionData
{
  public:
    enum COLOR_NAME { RED = 0,
                      ...
                      ORANGE,
                      VIOLET };
    std::array<std::array<pros::vision_signature_s_t, 6>, 5> COLOR_DATA =
        {{
            ...
            {{{4, {1, 0, 0}, 9.500000, -4105, -3529, -3818, -6795, -6129, -6462, 9421418, 1},
              {4, {1, 0, 0}, 6.400000, -2543, -1189, -1866, -7423, -6361, -6892, 14087804, 1},
              {4, {1, 0, 0}, 6.400000, -2543, -1189, -1866, -7423, -6361, -6892, 0, 1},
              {4, {1, 0, 0}, 7.000000, -3775, -2525, -3150, -7551, -6355, -6952, 0, 1},
              {4, {1, 0, 0}, 8.900000, -263, -155, -208, -4379, -3985, -4182, 0, 1},
              {4, {1, 0, 0}, 9.500000, -4105, -3529, -3818, -6795, -6129, -6462, 0, 1}}}, //橙色

            {{{5, {1, 0, 0}, 9.500000, -4105, -3529, -3818, -6795, -6129, -6462, 9421418, 1},
              {5, {1, 0, 0}, 6.400000, -2543, -1189, -1866, -7423, -6361, -6892, 14087804, 1},
              {5, {1, 0, 0}, 6.400000, -2543, -1189, -1866, -7423, -6361, -6892, 0, 1},
              {5, {1, 0, 0}, 7.000000, -3775, -2525, -3150, -7551, -6355, -6952, 0, 1},
              {5, {1, 0, 0}, 8.900000, -263, -155, -208, -4379, -3985, -4182, 0, 1},
              {5, {1, 0, 0}, 9.500000, -4105, -3529, -3818, -6795, -6129, -6462, 0, 1}}} //紫色
        }};
    VisionData(const json &pragma);
 ...
 */
  ...
  private:
    bool _isFlip = 0;
    const Vision _visionF;
    char _buf[256];
    int objCount = 0; //对象数量

    std::array<pros::vision_object_s_t, BASE_DATASUM> _data = {0}; //原始数据
...
static void taskVision(void *para)
{
    visionData->loop();
}