...
*/
     ...
     * @param threshold 遥控器矫正阀值
     */
    virtual void h_arcade(std::shared_ptr<pros::Controller> joy, pros::controller_analog_e_t verticalVal, pros::controller_analog_e_t horizontalVal, pros::controller_analog_e_t translationVal, const int speedMode[128] = realSpeed);
