...
void UserDisplay::createTerminal(lv_obj_t *parent)
{
    ...
    lv_btn_set_action(hidenBtn, LV_BTN_ACTION_CLICK, hidenAction);
    //error warnning 指示灯
    ...
    warnningLabs = lv_label_create(terminal, nullptr);
    lv_obj_set_pos(warnningLabs, LV_HOR_RES / 2 + 15, LV_VER_RES - 25);
    lv_label_set_recolor(warnningLabs, true);
